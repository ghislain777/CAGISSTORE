...
const path = require('path');
    ...
    const {  Utilisateur, Menu, Activite, Privilege, Media, Role} = require('../models');
const { sendEmail, sendConfirmationEmail } = require('../services/email/email_service');
