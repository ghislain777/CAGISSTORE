                    ...
                    <MuiThemeProvider theme={getMuiTheme()}>
                        <Card>
                            <CardHeader
                                ...
                                title={`Ajouter une photo au ville`
                                }
                                subheader={`${state.ville.nom}`}
                            />
                ...
                <Grid item lg={7} md={7} sm={12} xs={12} >
                    <Card>
                        <CardHeader
                            ...
                            title={`${state.ville.nom}`
                            }
                            subheader=''
                        />

                        <CardContent className=' px-6 pt-6 pb-6'>
                            <ImageList sx={{  width: 540, height: 600}}  cols={2} gap={8} >
                                {state.ville.Media.map((item) => (
