...
export default function FormulaireParametre(props) {
    ...
    nom='valeur'
    label={`Valeur`}
    valeur={state.parametre?.valeur }
    control={useform.control}
    error={useform.errors.valeur }
    />
    </Grid>
    ...
    nom='description'
    label={`Description`}
    valeur={state.parametre?.description }
    control={useform.control}
