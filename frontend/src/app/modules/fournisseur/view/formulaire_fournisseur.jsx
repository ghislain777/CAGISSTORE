...
export default function FormulaireFournisseur(props) {

    const { state, fonctions, queries, useforms } = props

    const useform = useforms.fournisseur
...
nom='telephone'
label='Téléphone'
valeur={state.fournisseur?.telephone }
control={useform.control}
...
nom='adresse'
label='Adresse'
valeur={state.fournisseur?.adresse }
control={useform.control}
...
nom='email'
label='Email'
valeur={state.fournisseur?.email }
control={useform.control}
...
nom='description'
label='Description'
valeur={state.fournisseur?.description }
control={useform.control}
