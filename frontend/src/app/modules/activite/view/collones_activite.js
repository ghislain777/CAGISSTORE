...
export default function getcollonesActivite(fonctions) {
  ...
  const getOptionActions = (activite) => {
        ...
        return [
          {
            id: 1,
            nom: 'Détails',
            action: (activite) => handleClickSurAction(activite, 'Détails'),
      ...
      case 'Nouveau':
        return [
          ...
          },
          {
            id: 2,
            nom: 'Modifier',
            action: (activite) => handleClickSurAction(activite, 'Modifier'),
            icon: <EditOutlined color='primary' />
          },
          {
            id: 3,
            nom: 'Supprimer',
            action: (activite) => handleClickSurAction(activite, 'Supprimer'),
  ...
  const handleClickSurAction = (activite, action) => {
   // console.log('Action sur une activite::::Action=' + action + ' activite :::' + activite.id);
   fonctions.handleClickSurAction(activite, action)
    ...
    //     break;
    //   case 'Modifier':
    //     fonctions.handleClickSurEdit(activite)
    //     break;
    //   case 'Supprimer':
    //     fonctions.handleClickSurSupprimer(activite)
    //     break;
    //   default:
    //     break;
    // }
...
chemain:tableMeta.rowData[3],
icone:tableMeta.rowData[4],
position:tableMeta.rowData[5],
menu:tableMeta.rowData[6],
