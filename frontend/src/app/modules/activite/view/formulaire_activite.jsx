...
export default function FormulaireActivite(props) {
    ...
    nom='description'
    label='Description'
    valeur={state.activite?.description}
    control={useform.control}
    ...
    nom='chemain'
    label='Chemain'
    valeur={state.activite?.chemain}
    control={useform.control}
    error={useform.errors.chemain}
    />
    </Grid>
    ...
    nom='position'
    label='Position'
    valeur={state.activite?.position}
    control={useform.control}
    error={useform.errors.position}
    />
    </Grid>
    
  <Grid item>
  {queries.queryMenus.isLoading ? (
    ...
    <FormSelect
        ...
        control={useform.control}
        options={
            queries.queryMenus.data['rows']
        }
        error={useform.errors.menu}
        defaultValue = {(state.activite?.menu?.id?? '1')}
        valeur={
            state.utilisateur?.menu ?? ''
        }
    ></FormSelect>
     )}
      </Grid>
