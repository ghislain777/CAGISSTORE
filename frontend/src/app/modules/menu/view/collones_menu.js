...
export default function getcollonesMenu(fonctions) {
        ...
        return [
          {
            id: 1,
            nom: 'Détails',
            action: (menu) => handleClickSurAction(menu, 'Détails'),
      ...
      case 'Nouveau':
        return [
          ...
          },
          {
            id: 2,
            nom: 'Modifier',
            action: (menu) => handleClickSurAction(menu, 'Modifier'),
            icon: <EditOutlined color='primary' />
          },
          {
            id: 3,
            nom: 'Supprimer',
            action: (menu) => handleClickSurAction(menu, 'Supprimer'),
  ...
  const handleClickSurAction = (menu, action) => {
   // console.log('Action sur une menu::::Action=' + action + ' menu :::' + menu.id);
   fonctions.handleClickSurAction(menu, action)
    ...
    //     break;
    //   case 'Modifier':
    //     fonctions.handleClickSurEdit(menu)
    //     break;
    //   case 'Supprimer':
    //     fonctions.handleClickSurSupprimer(menu)
    //     break;
    //   default:
    //     break;
    // }
...
icone:tableMeta.rowData[3],
position:tableMeta.rowData[4],
