...
export default function FormulaireMenu(props) {
    ...
    nom='icone'
    label='Icone'
    valeur={state.menu?.icone}
    control={useform.control}
    error={useform.errors.icone}
    />
    </Grid>
