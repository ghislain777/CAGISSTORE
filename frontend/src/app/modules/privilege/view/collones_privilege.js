...
export default function getcollonesPrivilege(fonctions) {
  ...
  const getOptionActions = (privilege) => {
    switch (privilege.statut) {
      case 'Annulé':
        return [
          {
            id: 1,
            nom: 'Détails',
            action: (privilege) => handleClickSurAction(privilege, 'Détails'),
      ...
      case 'Nouveau':
        return [
          ...
          },
          {
            id: 2,
            nom: 'Modifier',
            action: (privilege) => handleClickSurAction(privilege, 'Modifier'),
            icon: <EditOutlined color='primary' />
          },
          {
            id: 3,
            nom: 'Supprimer',
            action: (privilege) => handleClickSurAction(privilege, 'Supprimer'),
  ...
  const handleClickSurAction = (privilege, action) => {
    // console.log('Action sur une privilege::::Action=' + action + ' privilege :::' + privilege.id);
    fonctions.handleClickSurAction(privilege, action)
    ...
    //     break;
    //   case 'Modifier':
    //     fonctions.handleClickSurEdit(privilege)
    //     break;
    //   case 'Supprimer':
    //     fonctions.handleClickSurSupprimer(privilege)
    //     break;
    //   default:
    //     break;
    // }
                ...
                {getOptionActions(
                  {
                    ...
                    id: tableMeta.rowData[0],
                    description: tableMeta.rowData[4],
                    actif: tableMeta.rowData[3],
                    activite: tableMeta.rowData[2],
