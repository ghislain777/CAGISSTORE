...
export default function FormulaireMoyendepayement(props) {

    const { state, fonctions, queries, useforms } = props

    const useform = useforms.moyendepayement
...
nom='nom'
label='Nom'
valeur={state.moyendepayement?.nom }
...
nom='description'
label='Description'
valeur={state.moyendepayement?.description }
control={useform.control}
