...
export default function  FormFile2(props) {
  ...
  const  {onUpload} = props
    ...
    return (
        <div className="upload-form m-sm-30">
            ...
            <SimpleCard title="Upload de fichier">
                ...
                <div
                    className={clsx(
                        'h-100 w-full border-radius-4 bg-light-gray mb-6 flex justify-center items-center',
                        dargClass
                    )}
                ...
                >
                    {isEmpty ? (
                        <span>Glissez le fichier ici</span>
                    ) : (
                        <h5 className="m-0">
                ...
                <Card className="mb-6" elevation={2}>
                    ...
                    {isEmpty && <p className="px-4">Auccun fichier chargé</p>}
