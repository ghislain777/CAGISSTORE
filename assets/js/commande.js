...
const commande = {
    ...
    adressedelivraison:utilisateur.Adresses[0],
    adressedefacturation:utilisateur.Adresses[0],
...
$("#villedefacturation").val(utilisateur.Quartier.Commune.Ville.id);
$("#communedefacturation").append(`<option value=${utilisateur.Quartier.Commune.id}>${utilisateur.Quartier.Commune.nom}</option>`);
$("#communedefacturation").val(utilisateur.Quartier.Commune.id);
$("#quartierdefacturation").append(`<option value=${utilisateur.Quartier.id}>${utilisateur.Quartier.nom}</option>`);
$("#quartierdefacturation").val(utilisateur.Quartier.id);

$("#villedelivraison").val(utilisateur.Quartier.Commune.Ville.id);
$("#communedelivraison").append(`<option value=${utilisateur.Quartier.Commune.id}>${utilisateur.Quartier.Commune.nom}</option>`);
$("#communedelivraison").val(utilisateur.Quartier.Commune.id);
$("#quartierdelivraison").append(`<option value=${utilisateur.Quartier.id}>${utilisateur.Quartier.nom}</option>`);
$("#quartierdelivraison").val(utilisateur.Quartier.id);
...
commande.adressedefacturation.quartier = utilisateur.Quartier.id
commande.adressedelivraison.quartier = utilisateur.Quartier.id
